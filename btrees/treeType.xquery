...
<g transform="translate(50, 50)">
    <g transform = "translate(210)">
        <rect x="0" y="-15" width="20" height="20" fill="{$DOGreen}"/>
        <text x="30" y="0" fill="black">Deciduous</text>
        <rect x="150" y="-15" width="20" height="20" fill="{$Green}"/>
        <text x="180" y="0" fill="black">Coniferous</text>
    </g>
{
let $entries := 
