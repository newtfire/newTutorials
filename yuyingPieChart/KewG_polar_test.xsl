    ...
    <xsl:template match="/">
        <svg width="600px" viewBox="-100 100 1200 800">
            ...
            <g transform="translate(500, 500)" fill="black" font-weight="bold" font-size="{$font-size}" >
                ...
                <circle cx="{$colorX}" cy="{$colorY}" r="5" fill="red"/>
                <circle cx="{$natureX}" cy="{$natureY}" r="5" fill="red"/>
                <circle cx="{$shapeX}" cy="{$shapeY}" r="5" fill="red"/>
                <circle cx="{$techX}" cy="{$techY}" r="5" fill="red"/>
                
                <circle cx="{$colorMidX}" cy="{$colorMidY}" r="5" fill="blue"/>
                <circle cx="{$natureMidX}" cy="{$natureMidY}" r="5" fill="blue"/>
                <circle cx="{$shapeMidX}" cy="{$shapeMidY}" r="5" fill="blue"/>
                <circle cx="{$techMidX}" cy="{$techMidY}" r="5" fill="blue"/>
            </g>
