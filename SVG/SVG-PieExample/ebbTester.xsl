...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--2022-02-08 ebb: You can run this XSLT against ANY source document. Just select any well-formed XML document as the source XML
    in oXygen in order to run XSLT and output a pie chart. It is NOT PULLING DATA from an external source. -->
